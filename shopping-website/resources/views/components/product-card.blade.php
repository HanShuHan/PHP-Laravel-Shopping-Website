<div class="col-md-3 mb-4">
    <div class="card h-100 d-flex flex-column">
        <img class="card-img-top" src="{{ asset('images/place-holder.png') }}" alt="{{ $name }}">
        <div class="card-body flex-grow-1">
            <h5 class="card-title">{{ $name }}</h5>
            <p class="card-text mb-3" style="font-size: 0.6em;">{{ $description }}</p>
        </div>
        <div class="card-footer bg-white mt-auto">
            ...
            <div class="d-flex justify-content-start">
                <a href="{{ url('/product/'. $id) }}" class="btn btn-dark mb-2 me-2">More Info</a>
                @auth
